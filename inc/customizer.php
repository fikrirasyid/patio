 ...
 */
function patio_customize_preview_js() {
	wp_enqueue_script( 'patio_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
